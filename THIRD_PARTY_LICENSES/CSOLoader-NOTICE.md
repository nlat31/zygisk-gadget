...
covered by that MIT license. It does not relicense CSOLoader.

If CSOLoader is statically linked with zygisk-gadget into a single combined
binary, distribution of that combined binary must comply with AGPLv3,
including licensing the combined work under AGPLv3 and providing its complete
Corresponding Source as required by the license. Distributors are responsible
for satisfying all applicable AGPLv3 obligations.
